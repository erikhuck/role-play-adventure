...
const GameMaster = () => {
    ...
    useEffect(() => {
        (async () => {
            const {abilityTemplates, itemTemplates, npcTemplates} = await apiFetch('templates', 'GET')
    ...
    return (dataLoaded ? (
            <>
                ...
                <CollapsibleComponent label='Abilities'>
                    <AbilityTemplates abilityTemplates={abilityTemplates} handleNewAbilityTemplate={handleNewAbilityTemplate} deleteAbilityTemplate={deleteAbilityTemplate}/>
